...
- - -
# 備註
當然，你可能會想說，我們上面看到的線性轉換都是方陣乘以向量，那如果我們今天是非方陣去乘以向量呢？例如用3x2的矩陣去對2x1的向量去做線性轉換，他有什麼意思？
當你把它相乘之後，你可以看到，你的2x1的向量會變成3x1的向量，他直接變成跳脫二維空間，變成在三維空間裡面的向量了。

用符號來說，就是一個$m\times n$的矩陣表示把

所以以方陣進行的線性轉換，是在同一個維度將空間進行重新詮釋。但非方陣的線性轉換，甚至會橫跨不同維度的空間，至於要降維還是升維，就看你用什麼樣的向量。
- - -
# 參考資料
