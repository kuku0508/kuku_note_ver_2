...
當我在記要怎麼矩陣乘以矩陣時，我都會記當我們要矩陣相成的時候，我們可以透過彼此的列行數來先知道相乘之後矩陣的列行數。例如，我需要把3x2矩陣乘以2x5矩陣，我們就可以知道，他會變成3x5矩陣，你可以想像成，我們把3x2 2x5壓在一起，他們變成只剩前矩陣的前項（列數）還有後矩陣的後項（行數）。順帶一提，如果要把兩個矩陣相乘，前項
