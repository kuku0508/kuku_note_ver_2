...
tags:
  ...
  - 完全隨機實驗
---
完全隨機設計（Completely randomized design, CRD），是一種[[實驗設計]]方法，主要重視的是在實驗中，對於不同處理的實驗進行指派是完全隨機。

在實務上，完全隨機設計常用於單因子實驗，因此又常被稱為「單因子完全隨機實驗」。
- - -
# 定義
...
- 每一個不同實驗的[[處理]]為完全隨機指派。
- 實驗的觀察對象除了主要研究的[[因子]]外，應盡量保持相似條件，避免差異影響結果。
- - -
# 範例
