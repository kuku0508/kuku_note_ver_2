...
屬於環節:
---
PROC SORT，是一種SAS的[[procedures]]。我們主要可以透過PROC SORT來對[[知識/統計/SAS/基礎知識/資料集]]的特定變數進行排序。
- - -
# 基本語法
```SAS
PROC SORT 資料集參數= 常用選項;
...
| 11  | 123456794 | Jerry  | M   | 10   | 0    | 5    | 5.00  |
上面的要求看起來很雜，我們稍微整理一下。
...
- - -
parent::[[procedures]],[[知識/統計/SAS/基礎知識/資料集]]
sibling::
child::