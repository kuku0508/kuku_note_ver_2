...
$$
雖然正常來說二項分配的呈現至少會是呈現這樣，但是在SAS裡面她的0.5的次方裡面的$n_t$變成了$n_t-1$，我看到的原因是因為跟分布對稱性有關。什麼意思，我看不是很懂，歡迎有懂的人來解釋一下。但總之，他出來的結果不會跟我們原本學的[[單樣本符號檢定]]多大的差異。
- - -
parent::[[Cox-Stuart test]],[[SAS目錄]]