...
2\cdot min \lbrace P(\chi_{n-1}^2\leq \chi^2_{obs}),\,P(\chi_{n-1}^2\geq \chi^2_{obs})\rbrace &\text{when }H_1\text{：}\mu\neq \mu_0\\\\

P(\chi^2_{n-1}\geq\chi^2_{obs}),&\text{when }H_1\text{：}\mu> \mu_0\\\\
