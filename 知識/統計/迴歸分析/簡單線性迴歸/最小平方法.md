...
&=E(\frac{\sum^n_{i=1}(x_i-\bar{x})(\beta_0+\beta_1x_i)}{\sum^n_{i=1}(x_i-\bar{x})^2})\\
&=E(\frac{0\cancel{\sum^n_{i=1}(x_i-\bar{x})}\beta_0+\sum^n_{i=1}(x_i-\bar{x})\beta_1x_i}{\sum^n_{i=1}(x_i-\bar{x})^2})\\
&=E(\frac{\sum^n_{i=1}(x_i-\bar{x})\beta_1x_i}{\sum^n_{i=1}(x_i-\bar{x})^2})\\
&=E(\beta_1\frac{\sum^n_{i=1}(x_i-\bar{x})x_i}{\sum^n_{i=1}(x_i-\bar{x})^2})\\
\end{align}
$$
- - -
parent::[[簡單線性迴歸]]