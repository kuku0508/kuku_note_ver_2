...
透過Chi-Square plot、皮爾森相關係數，我們皆得到**各廠商的資產服從常態分配**的結論。
### **銷售（Sales）&資產（Assets）**
...
H_0\text{：}\rho =0\quad  vs \quad  H_1\text{：}\rho\neq0
$$
根據R的輸出，其P-Value為「0.00001248」，故我們拒絕虛無假設，我們有足夠強烈的證據證明各廠商銷售額以及資產的馬氏距離的平方與卡方分配百分位數之間有顯著的線性關係。也就是各廠商銷售額以及利潤服從二維常態分配。
