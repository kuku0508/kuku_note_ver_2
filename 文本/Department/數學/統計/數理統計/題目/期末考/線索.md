...
&=n\frac{1}{\theta}+\sum^n_{i=1}x_i\frac{d}{du}\left[\ln u\right]\\
&=n\frac{1}{\theta}+\sum^n_{i=1}x_i\cdot\frac{1}{u}\frac{du}{dx}\\
...
&\theta=\frac{n}{\sum^n_{i=1}x_i+n}\\
&\because\bar{X}=\frac1n\sum^n_{i=1}x_i\Rightarrow
\end{align}
$$
...
$$
\begin{align}
\frac{d}{d\theta}\left[\ln\theta+2\ln(1-\theta)\right]&=\frac{d}{d\theta}\ln\theta+\frac{d}{d\theta}2\ln(1-\theta)\\
&=\frac{1}{\theta}+\frac{d}{du}2\ln u\\
&=\frac{1}{\theta}+2\frac{1}{u}\frac{du}{d\theta}\\
&=\frac{1}{\theta}+2\frac{1}{u}\cdot(-1)\\
