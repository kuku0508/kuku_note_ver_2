...
#### 問他的MLE是不是最小充分
Since MLE exists uniquely, and MLE is one-to-one function of $T(\underline{X})$, $\hat{\theta}$, $T(\underline{X})$ is information equivalent, therefore MLE is also sufficient.