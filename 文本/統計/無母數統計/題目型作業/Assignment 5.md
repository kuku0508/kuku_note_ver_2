...
# 回答：
Von Burg 和 Rustam (E15) 報告了表 3.23 中顯示的正中神經傳導速度數據。實驗組的受試者是在醫院中被診斷為甲基汞中毒且吃了受污染的麵包。對照組則是醫院人員，據推測未接觸到受污染的麵包。這些數據是否提供了足夠的證據表明兩個樣本代表的群體具有不同的分布？令顯著水準為 $\alpha = 0.025$。
