...
- 在注射不同的麻醉劑後，狗狗血漿內的游離兒茶酚胺的濃度可以進行排序。
## 虛無假設

令
$M_1$為注射異服醚後狗狗血漿中的游離兒茶酚胺濃度的中位數。
$M_2$為注射氟烷後狗狗血漿中的游離兒茶酚胺濃度的中位數。
$M_1$為注射環丙烷後狗狗血漿中的游離兒茶酚胺濃度的中位數。
$R_1$為注射異氟醚後每一隻狗狗血漿中的游離兒茶酚胺濃度與其他麻醉劑比較之排名總和。
$R_2$為注射氟烷後每一隻狗狗血漿中的游離兒茶酚胺濃度與其他麻醉劑比較之排名總和。
$R_3$為注射環丙烷後每一隻狗狗血漿中的游離兒茶酚胺濃度與其他麻醉劑比較之排名總和。
$$
H_0\text{：}M_1=M_2=M_3\quad\text{versus}\quad H_1\text{：}M_2\leq M_1\leq M_3 至少有一個M_i\neq
$$
## 檢定統計量
$$
\begin{array}{rr}
