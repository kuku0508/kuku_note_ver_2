...
$$
H_0\text{：}M_1=M_2=M_3\quad\text{versus}\quad H_1\text{：}M_2\leq M_1\leq M_3
$$
# 檢定統計量
...
我們可以看到Jonckheere-Terpstra test統計量J=111的p-value小於0.005，故我們拒絕虛無假設，我們有強烈的證據證明三組之間的肺活量值具有明顯差異，且接受額外肺部照射或胸腔手術的兒童之肺活量值」小於
## Exercise 7.2
